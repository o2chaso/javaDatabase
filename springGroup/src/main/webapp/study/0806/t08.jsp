...
<div class="container">
  ...
  <form name="myform" method="post" action="<%=request.getContextPath() %>/j0806/T08">
	  <div class="mb-3">성명
	  	  <input type="text" name="name" value="이동준" class="form-control mb-3" autofocus required />
	  	</div>
	  	<div class="mb-3">나이
	  	...
	  	<div class="row">
	  	  ...
	  	  <div class="col"><input type="button" value="전송(submit)" onclick="fCheck()" class="btn btn-success"/></div>
