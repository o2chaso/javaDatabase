...
<div class="container mt-5">
	<div class="a">
    	<div class="b bg-primary text-white">
			<h2 class="mb-1">전송된 값(t08Ok.jsp)</h2>
		</div>
		<div class="c">
		...
		<div>나이: <%=request.getAttribute("age") %> </div> --%>
			<table class="table table-bordered align-middle w-100" style="table-layout: auto;">
  			...
  			<div><input type="button" value="돌아가기" onclick="location.href='<%=request.getContextPath() %>/study/0806/t08.jsp'" class="btn btn-primary" /></div>	
		</div>
	</div>
</div>
<p><br/></p>
