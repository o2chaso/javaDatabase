...
public class T15_2Ok extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String name = getInitParameter("name") == null ? "" : getInitParameter("name");
		String hakbun = getInitParameter("name") == null ? "" : getInitParameter("hakbun");
		String hostIp = getInitParameter("name") == null ? "" : getInitParameter("hostIp");
