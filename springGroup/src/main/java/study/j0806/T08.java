...
//			out.println("<script>alert('성명은 한글 2~5만 입력 할수 있습니다.');history.back();</script>");
//		}
...
//		String[] mountains = request.getParameterValues("mountain"); // 하나라도 체크가 되었을 때 true
...
//		}
		...
		// 서버에 정상적으로 처리된 자료(찍어본 자료)를 View(JSP)페이지로 전송시켜서 예쁘게 출력시켜 준다.
